#### 1. if we have resources "nested" inside of another resource("Nested resources"), we MUST declare a destroy function that manually destroys those "nested" resources with the destroy keyword.
